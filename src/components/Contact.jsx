   ...
   return (
      <section id="contact" className="py-20 px-4 bg-white text-center">
         ...
         <form onSubmit={handleSubmit} className="max-w-xl mx-auto space-y-4">
            ...
            <button
               type="submit"
               className="w-full bg-emerald-700 text-white py-2 px-4 animate-bounce shadow-xl/30 hover:bg-emerald-800 transition-colors duration-200 cursor-pointer rounded"
            >
               Send
            </button>
            {status && (
