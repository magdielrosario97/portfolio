...
const Skills = () => {
   const skillCategories = [
      {
         title: "Languages",
         skills: ["JavaScript", "Python", "Java", "SQL", "C++", "HTML", "CSS"],
      },
      {
      ...
      {
         title: "Tools",
         skills: ["Git", "GitHub", "Bash", "Postman", "Linux (Ubuntu)"],
      },
      {
         title: "Practices",
         skills: ["REST APIs", "Object-Oriented Programming", "Test-Driven Development", "Debugging", "Agile/Scrum"],
      },
   ];
